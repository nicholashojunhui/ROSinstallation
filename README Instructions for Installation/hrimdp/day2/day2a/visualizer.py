...
timestamps = min(len(human_states), len(robot_states))

visualize(gridworld, timestamps, human_trajectory=human_states, robot_trajectory=robot_states, rewards_trajectory=rewards_trajectory)