...
def main():
	...
	if (train_indicator==1):
		actor_critic.read_human_data()	#only for training

		#actor_critic.actor_model.load_weights("actormodel-120-500.h5")
		#actor_critic.critic_model.load_weights("criticmodel-120-500.h5")
